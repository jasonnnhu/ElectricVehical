...
3. "Personal Consumption Data in Washington State" from from Bureau of Economic Analysis, U.S. Department of Commerce, available on bea.gov.
...
sampled_ev_data <- ev_data %>% 
  slice_sample(n = 50000)  

vis_miss(sampled_ev_data)
```
